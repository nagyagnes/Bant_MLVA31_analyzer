...
./Bant_MLVA31_analyzer.sh -p /opt/Bant_MLVA31_analyzer/Supporting_files -d /opt/Bant_MLVA31_analyzer/Script_directory -s Test_1,Test_2 -o $DIR_PATH/Demo_files -m Y -i N
